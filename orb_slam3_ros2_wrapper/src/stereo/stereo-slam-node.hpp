...
namespace ORB_SLAM3_Wrapper
{
    ...
    private:
        ...
        void StereoCallback(const sensor_msgs::msg::Image::SharedPtr msgRgbLeft,
        ...
        std::shared_ptr<message_filters::Subscriber<sensor_msgs::msg::Image>> rgbLeftSub_;
        std::shared_ptr<message_filters::Subscriber<sensor_msgs::msg::Image>> rgbRightSub_;
